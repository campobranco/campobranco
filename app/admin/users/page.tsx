        ...
        <div className="min-h-screen bg-background pb-32 font-sans text-main">
            ...
            {showCreateModal && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
                    <div className="bg-surface border border-surface-border text-main rounded-xl w-full max-w-sm p-6 shadow-2xl animate-in zoom-in-95 duration-300">
                        ...
                        <form onSubmit={handleCreateUser} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-background border border-surface-border rounded-lg p-4 font-bold text-main placeholder-muted focus:ring-2 focus:ring-primary/20 outline-none"
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-background border border-surface-border rounded-lg py-3 pl-10 pr-4 font-bold text-main placeholder-muted focus:ring-2 focus:ring-primary/20 outline-none text-sm"
                                        />
                                    </div>
                                    {showCongDropCreate && (
                                        <>
                                            ...
                                            <div className="absolute left-0 right-0 top-full mt-1 bg-surface rounded-xl shadow-2xl border border-surface-border z-20 max-h-48 overflow-y-auto">
                                                ...
                                                {congregations.filter(c => c.name.toLowerCase().includes(congSearchCreate.toLowerCase())).map(c => (
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-4 py-2.5 text-sm font-bold hover:bg-background transition-colors ${ newUser.congregationId === c.id ? 'text-primary font-extrabold' : 'text-main'}`}
                                                    >
                                                        {c.name}
                                                    </button>
                                                ))}
                            ...
                            <button
                                ...
                                className="w-full py-4 bg-primary hover:bg-primary-dark text-white rounded-lg font-bold shadow-lg mt-2 flex items-center justify-center gap-2 active:scale-95 transition-transform"
                            >
                                            ...
                                            <div className="absolute left-0 right-0 top-full mt-1 bg-surface rounded-xl shadow-2xl border border-surface-border z-20 max-h-48 overflow-y-auto">
                                                ...
                                                {congregations.filter(c => c.name.toLowerCase().includes(congSearchEdit.toLowerCase())).map(c => (
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-4 py-2.5 text-sm font-bold hover:bg-background transition-colors ${ editCongId === c.id ? 'text-primary font-extrabold' : 'text-main'}`}
                                                    >
                                                        {c.name}
                                                    </button>
                                                ))}
                                                ...
                                                <button
                                                    ...
                                                    className={`p-4 rounded-lg border text-sm font-bold transition-all flex items-center justify-between
                                                        ${isActive
                                                            ...
                                                            : 'bg-background border-surface-border text-muted hover:text-main hover:bg-surface-border/40'
                                                        }
                                                    `}
                                                >
