                                                        ...
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div className="flex flex-col items-start min-w-0">
                                                                 <div className="flex items-baseline gap-2 min-w-0 flex-wrap">
                                                                     <div className="font-bold text-main text-lg leading-tight shrink-0">{t.name}</div>
                                                                     {(t.notes || t.description) && (
                                                                         <div className="text-sm text-muted font-normal line-clamp-1 max-w-md" title={t.notes || t.description}>
                                                                             - {t.notes || t.description}
                                                                         </div>
                                                                     )}
                                                                 </div>
